---
title: Buiding an app with preact-js using appwrite
description: Build a Todolist with preact-js using appwrite as a backend
date: "2022-10-08"
---

# Buiding an app with preact-js using appwrite

<img alt="Buiding an app with preact-js using appwrite" src="https://cdn.hashnode.com/res/hashnode/image/upload/v1665324251529/WBes3e1cs.png?w=1600&amp;h=840&amp;fit=crop&amp;crop=entropy&amp;auto=compress,format&amp;format=webp" class='appwrite-img' />
